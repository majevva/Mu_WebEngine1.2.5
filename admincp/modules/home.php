...
echo '<div class="row">';
		...
		echo '<div class="panel-body">';
			...
			echo '<div class="list-group">';
				...
				echo '<div class="list-group-item" target="_blank">';
					...
					echo '</span>';
				echo '</div>';
				echo '<a href="https://latinohosting.net/" class="list-group-item" target="_blank">';
					echo 'WebEngine';
					echo '<span class="pull-right text-muted small">';
	...
	echo '<div class="col-md-6">';
		...
		echo '<div class="panel-body">';
			echo '<div style="margin-bottom:7px;"><a href="https://latinohosting.net/" class="btn btn-default" target="_blank">Discord</a></div>';
			echo '<iframe src="//www.facebook.com/plugins/likebox.php?href=https%3A%2F%2Fwww.facebook.com%2FLatinoHost.net&amp;width=600&amp;height=447&amp;colorscheme=light&amp;show_faces=false&amp;header=false&amp;stream=true&amp;show_border=false&amp;appId=1439010682981422" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100%; height:447px;" allowTransparency="true"></iframe>';
		echo '</div>';
		echo '</div>';
	echo '</div>';
echo '</div>';